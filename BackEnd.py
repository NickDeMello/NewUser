...
class Write:
    ...
    def _set_permissions(self):
        ...
        elif self.person.service:
            self.permissions += self._fetch(r, 4)
            
    def _set_queues(self):
        r = self._find_rows("Queue")
        self.queues += self._fetch(r, 2)
